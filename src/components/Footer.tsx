            ...
            <div className="grid grid-cols-1 gap-3 w-full max-w-xs py-6">
              {[
                ...
                <div key={tech.name} className="flex items-center justify-center lg:justify-normal space-x-3">
                  ...
                  <div className="h-5 w-5 object-contain filter brightness-0 invert opacity-50 bg-gray-400 rounded-full"></div>
                  <span className="text-[var(--white-icon)] text-sm">
                    {tech.name}
                  </span>
                </div>
          ...
          <div className="flex flex-col items-center lg:items-start space-y-6">
            <div className="w-full max-w-xs">
              <iframe
                ...
                src="https://open.spotify.com/embed/playlist/1HKS0iA8JCyihncd27Ag6J?utm_source=generator&theme=0&locale=en_US"
